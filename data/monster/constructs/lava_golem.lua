...
monster.loot = {
	{id = "gold coin", chance = 10000, maxCount = 199},
	{id = "platinum coin", chance = 10000, maxCount = 11},
	{id = "yellow gem", chance = 2480},
	...
	{id = "strong health potion", chance = 1830, maxCount = 2},
	{id = "strong mana potion", chance = 1150, maxCount = 2},
	{id = "great mana potion", chance = 1630, maxCount = 2},
	{id = "mana potion", chance = 2720, maxCount = 2},
	{id = "magma amulet", chance = 2900},
	{id = "magma boots", chance = 2650},
	{id = "magma coat", chance = 430},
	{id = "ultimate health potion", chance = 1390},
	{id = "spellbook of mind control", chance = 450},
	{id = "fiery heart", chance = 1350},
	{id = "wand of everblazing", chance = 1390},
	{id = "violet crystal shard", chance = 3200},
	{id = "green crystal splinter", chance = 1390, maxCount = 2},
	{id = "red crystal fragment", chance = 1990},
	{id = "magma clump", chance = 1570, maxCount = 2},
	{id = "blazing bone", chance = 1500},
	{id = "prismatic bolt", chance = 1280, maxCount = 5}
}
