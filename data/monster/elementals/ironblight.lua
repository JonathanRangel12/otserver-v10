...
monster.loot = {
	{id = "gold coin", chance = 5000, maxCount = 199},
	{id = "small emerald", chance = 1890, maxCount = 3},
	{id = "small amethyst", chance = 1520, maxCount = 3},
	{id = "platinum coin", chance = 8000, maxCount = 8},
	{id = "red gem", chance = 3510},
	{id = "blue gem", chance = 480},
	{id = "epee", chance = 480},
	{id = "magic sulphur", chance = 830},
	{id = "sapphire hammer", chance = 480},
	{id = "great mana potion", chance = 1760},
	{id = "terra legs", chance = 1110},
	{id = "ultimate health potion", chance = 1330},
	...
	{id = "war crystal", chance = 2130},
	{id = "shiny stone", chance = 1530},
	{id = "jade hat", chance = 210},
	{id = "glacial rod", chance = 960},
	{id = "green crystal shard", chance = 5720},
	{id = "brown crystal splinter", chance = 1610, maxCount = 2},
	{id = "red crystal fragment", chance = 1040},
	{id = "crystalline spikes", chance = 1800}
}
